...
craft_list = {
    ...
    'CutBasalt': [{'Basalt': 2}],
    'Paper': [{'OakLog': 10}],
    'RemovalSigil': [{'CutStone': 20}, {'Paper': 20}, {'WaterRune': 10}, {'MapleLog': 30}],
    '': '',
    ...
    '       ': '',
    '1WarBornChestplate': [{'TinIngot': 50}, {'IronIngot': 50}],
    '2WarBornChestplate': [{'1WarBornChestplate': 1}, {'Bone': 200}],
    '3WarBornChestplate': [{'2WarBornChestplate': 1}, {'Leather': 200}, {'GoldIngot': 200}, {'GemIngot': 40}],
